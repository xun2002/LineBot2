...
admin =['u45c1325c7db7d1685360dcc008aebea9','ucaaf32f880c10e14b0e868143210da57',clMID]
owners = ["u3621d3080e352347faf11586581f6d16","u3621d3080e352347faf11586581f6d16"]
...
#==============================================================================#
            if sender in K0:
                if text.lower() == 'help':
                    ...
                    if sender == "u45c1325c7db7d1685360dcc008aebea9":
                        cl.sendMessage(to,"Bye2")
                        cl.leaveGroup(msg.to)
#==============================================================================#
                elif text.lower() == 'sp':
                    start = time.time()
                    cl.sendMessage(to, "藍天慢跑中...")
...
#==============================================================================#
                    ...
                    for target in targets:
                        try:
                            ...
                            cl.sendMessage(to,"Error")
                elif text.lower() == '藍天破壞中':
                    if msg.toType == 2:
                        print ("[ 19 ] KICK ALL MEMBER")
                        _name = msg.text.replace("藍天破壞中","")
                        gs = cl.getGroup(msg.to)
                        cl.sendMessage(msg.to,"破壞倒數...3...2...1...☆月滅骑士团...栄光の破壊☆")
                        targets = []
                        for g in gs.members:
                    ...
                    cl.sendMessage(msg.to,"藍天寶寶已取消所有邀請!")
